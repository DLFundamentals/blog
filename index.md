...
<div style="margin-bottom:2.5rem">
  <a href="{{ post.url | relative_url }}" style="text-decoration:none;border:none">
    <h2 style="font-family:'Newsreader',Georgia,serif;font-weight:500;font-size:1.6rem;color:#0a1628;letter-spacing:-0.02em;line-height:1.25;margin:0 0 0.4rem 0;border:none;padding:0;transition:color 0.2s">
      {{ post.title }}
    </h2>
  </a>
