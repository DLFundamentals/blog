...
Now the second term is a sum of $n$ mini-batch gradients, each of rank at most $B$. Therefore its rank is at most $nB$. This gives the effective-rank bound

$$
\textnormal{rank}_\varepsilon(W_T) \;\lesssim\; \frac{B \log(1/\varepsilon)}{\mu\lambda}.
$$

The notation $\textnormal{rank}_\varepsilon$ means the minimum rank of a matrix that approximates $W_T/\|W_T\|$ up to error $\varepsilon$.
