...
Here $\operatorname{rank}_\varepsilon$ denotes the minimum rank of a matrix that approximates $W_T/\|W_T\|$ up to error $\varepsilon$.
...
## Why the decomposition $h_W(x)=g(Wf(x))$ is natural
