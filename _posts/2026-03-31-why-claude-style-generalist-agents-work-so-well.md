...
.post-scope .loop-step:last-child::before{
  display:none;
}

.post-scope .loop-icon{
  width:48px;
  height:48px;
  border-radius:50%;
  display:flex;
...
.post-scope .loop-step:hover .loop-icon{
  transform:scale(1.1);
}

.post-scope .loop-content{
  padding-bottom:1.5rem;
  min-width:0;
}

.post-scope .loop-label{
  font-family:var(--sans);
  font-weight:600;
  font-size:15px;
  color:var(--ink);
...
.post-scope .tool-table td{
  padding:8px 12px;
  border-bottom:1px solid var(--rule);
  vertical-align:top;
}

.post-scope .tool-table td:first-child{
  font-family:var(--mono);
  font-size:12px;
  color:var(--accent);
  white-space:nowrap;
...
.post-scope .uncertainty-meter{
  margin:1rem 0 1.5rem;
  font-family:var(--sans);
}

.post-scope .meter-label{
  font-size:12px;
  color:var(--ink-muted);
  margin-bottom:6px;
  display:flex;
